...
from p1_alien_invasion.project_1_exercises.pg_375_tiy_14_3.settings import Settings
from p1_alien_invasion.project_1_exercises.pg_375_tiy_14_3.ship import Ship
from p1_alien_invasion.project_1_exercises.pg_375_tiy_14_3.bullet import Bullet
from p1_alien_invasion.project_1_exercises.pg_375_tiy_14_3.rectancle import Target
from p1_alien_invasion.project_1_exercises.pg_375_tiy_14_3.game_stats import GameStats
from p1_alien_invasion.project_1_exercises.pg_375_tiy_14_3.button import Button
...
class ShootTheBlock:
    ...
    def check_if_bullets_hit_targets(self):
        ...
        if pygame.sprite.groupcollide(self.bullets, self.targets, True, True):
            self.settings.initialize_original_settings()
